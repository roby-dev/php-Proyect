  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Nuevo Lugar</h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="post" id="addcategory" action="index.php?action=places&opt=add" role="form">
              ...
              ?>
                <tr>
                  ...
                  <td style="width:130px;">
                    ...
                    <a href="index.php?action=places&opt=del&id=<?php echo $user->id; ?>" class="btn btn-danger btn-xs">Eliminar</a></td>
                </tr>
              <?php
                    ...
                    <div class="modal-body">
                      <form class="form-horizontal" method="post" id="addproduct" action="index.php?action=places&opt=update" role="form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6">
                            <input type="text" name="name" value="<?php echo $user->name; ?>" class="form-control" id="name" placeholder="Categoria" required>
                          </div>
                        </div>
      ...
      <?php
        ...
        echo "<p class='alert alert-danger'>No hay Lugares</p>";
      }
