...
<head>
  <meta charset="UTF-8">
  <title>ATS | Panel de Administracion</title>
...
<body class="<?php if (isset($_SESSION["user_id"]) || isset($_SESSION["pacient_id"]) || isset($_SESSION["medic_id"])) : ?>  skin-black sidebar-mini <?php else : ?>login-page<?php endif; ?>">
  <div class="wrapper">
    <!-- Main Header -->
    <?php if (isset($_SESSION["user_id"]) || isset($_SESSION["pacient_id"]) || isset($_SESSION["medic_id"])) : ?>
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>ATS</b></span>
    ...
    <?php if (isset($_SESSION["user_id"])  || isset($_SESSION["pacient_id"]) || isset($_SESSION["medic_id"])) : ?>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020 - Desarollo de Aplicaciones Web</strong>
      </footer>
    <?php else : ?>
      ...
      <?php else : ?>
        <div class="login-box">
          <div class="login-logo">
            <a href="./"><b>Applicant Tracking System</b></a>
          </div><!-- /.login-logo -->
