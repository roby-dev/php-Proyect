...
if (!isset($_GET['id'])) {
    ...
    $resultados = $resultado->getAceptados($_GET['id']);
...
?>
<div id="titulo-index">
    <h1 class="h1-strong h1-strong-detalle" id="h1-strong">Méritos</h1>
...
<section class="col-lg-12 mx-auto mb-5 section-responsive mt-5">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Cuadro de méritos</li>
        </ol>
    </nav>
    <h3 class="h3-strong-category">Lista de resultados de entrevista<br><small><a href='detalle.php?codigo=<?php echo $jobs['id']; ?>'><?php echo $jobs['name'] ?></a></small></h3>
        ...
        <table class="table table-hover col-9 mx-auto mt-5 mb-5">
            ...
            <tbody class="col-12">
                ...
                $sql = $mysqli->prepare(" SELECT person.id,person.name,person.lastname,person.dni,DATE_FORMAT(person.created_at,'%d/%m/%Y'),person.job_id,person.status,job.name as jobName
                                    ...
                                    where job.id=" . $_GET['id'] . " and (person.status=0 or person.status=2)
                                    ORDER BY person.status DESC
                                    LIMIT ?,10
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;color:#555" class="text-muted">
                            <?php
                            if ($campo['status'] == '2') echo "<b><span style='color:blue'>Contratado</span></b>";
                            else if ($campo['status'] == '0') echo "<span style='color:red'>Rechazado</span>";
    ...
    <?php
        ...
        echo "<div class='alert alert-danger col-10 mx-auto mt-5 mb-5 text-center d-flex justify-content-center align-items-center'><b>No hay cuadro de méritos para este trabajo</b></div>";
    }
    ?>
...
<div class="col-12">
    <ul class="row detalle-lista" id="enlaces">
        ...
        if ($jobs['status'] === "1") {
            ...
            echo "<li class='p-3'><a>Entrevista</a></li>";
            echo "<li class='p-3'><a>Resultados</a></li>";
        }
        ?>
